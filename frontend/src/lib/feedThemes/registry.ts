...
export const FEED_THEMES: Record<string, FeedTheme> = {
  ...
  // ── Genres ───────────────────────────────────────────────────────────
  // Keyed by canonical slug (see GENRE_ID_TO_SLUG in resolveFeedTheme.ts).
  // Restrained, editorial accents so posters stay the hero; bands fade at the
  // edges and motifs stay faint (opacity ~0.06–0.10).
  'genre:horror': {
    id: 'horror',
    accent: '#8E2C2C',
    accentSoft: '#D86A60',
    glow: 'rgba(142,44,44,0.28)',
    band: 'linear-gradient(90deg, rgba(142,44,44,0) 0%, rgba(142,44,44,0.15) 26%, rgba(20,6,6,0.5) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'display', className: 'italic tracking-tight' },
    motif: { kind: 'grain', opacity: 0.07 },
    eyebrowOverride: 'After Dark',
  },
  'genre:scifi': {
    id: 'scifi',
    accent: '#3FB7C4',
    accentSoft: '#8FE3EC',
    glow: 'rgba(63,183,196,0.26)',
    band: 'linear-gradient(90deg, rgba(63,183,196,0) 0%, rgba(63,183,196,0.13) 26%, rgba(10,40,60,0.4) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'ui', className: 'uppercase font-semibold tracking-[0.12em]' },
    motif: { kind: 'grid', opacity: 0.1 },
    eyebrowOverride: 'The Future Is Now',
  },
  'genre:action': {
    id: 'action',
    accent: '#E08A2B',
    accentSoft: '#F4B860',
    glow: 'rgba(224,138,43,0.28)',
    band: 'linear-gradient(90deg, rgba(224,138,43,0) 0%, rgba(224,138,43,0.14) 26%, rgba(70,36,8,0.32) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'ui', className: 'uppercase font-extrabold tracking-tight' },
    motif: { kind: 'beams', opacity: 0.08 },
    eyebrowOverride: 'Full Throttle',
  },
  'genre:romance': {
    id: 'romance',
    accent: '#C77B92',
    accentSoft: '#ECB4C4',
    glow: 'rgba(199,123,146,0.24)',
    band: 'linear-gradient(90deg, rgba(199,123,146,0) 0%, rgba(199,123,146,0.13) 26%, rgba(60,24,36,0.28) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'display', className: 'italic tracking-tight' },
    motif: { kind: 'bokeh', opacity: 0.1 },
    eyebrowOverride: 'Matters of the Heart',
  },
  'genre:crime': {
    id: 'crime',
    accent: '#9AA7B4',
    accentSoft: '#CBD4DD',
    glow: 'rgba(154,167,180,0.18)',
    band: 'linear-gradient(90deg, rgba(18,20,24,0) 0%, rgba(30,34,40,0.5) 50%, rgba(18,20,24,0) 100%)',
    title: { font: 'ui', className: 'uppercase font-bold tracking-[0.18em]' },
    motif: { kind: 'slats', opacity: 0.08 },
    eyebrowOverride: 'Shadows & Smoke',
  },
  'genre:comedy': {
    id: 'comedy',
    accent: '#E8B62F',
    accentSoft: '#F6D873',
    glow: 'rgba(232,182,47,0.26)',
    band: 'linear-gradient(90deg, rgba(232,182,47,0) 0%, rgba(232,182,47,0.13) 26%, rgba(70,52,10,0.26) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'ui', className: 'font-extrabold tracking-tight' },
    motif: { kind: 'halftone', opacity: 0.09 },
    eyebrowOverride: 'Comic Relief',
  },
  'genre:fantasy': {
    id: 'fantasy',
    accent: '#8E7BD6',
    accentSoft: '#C2B4F2',
    glow: 'rgba(142,123,214,0.26)',
    band: 'linear-gradient(90deg, rgba(142,123,214,0) 0%, rgba(142,123,214,0.13) 26%, rgba(36,28,70,0.34) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'display', className: 'italic tracking-tight' },
    motif: { kind: 'sparkle', opacity: 0.1 },
    eyebrowOverride: 'Realms of Wonder',
  },
  'genre:western': {
    id: 'western',
    accent: '#BB6B3A',
    accentSoft: '#E2A06A',
    glow: 'rgba(187,107,58,0.24)',
    band: 'linear-gradient(90deg, rgba(187,107,58,0) 0%, rgba(187,107,58,0.13) 26%, rgba(60,34,16,0.3) 62%, rgba(10,10,11,0) 100%)',
    title: { font: 'display', className: 'uppercase tracking-[0.08em]' },
    motif: { kind: 'beams', opacity: 0.07 },
    eyebrowOverride: 'The Frontier',
  },
};
